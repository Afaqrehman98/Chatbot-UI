...
public class ATMLocator extends FragmentActivity implements
        OnMapReadyCallback,
        ...
        LocationListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_atmlocator2);
    ...
    public void onClick(View v){
        ...
        NearbyATM getNearbyPlaces = new NearbyATM();
    ...
    private String getUrl(double latitude,double longitude,String atm){
        ...
        googleURL.append("&key=" + "AIzaSyBAEHOK-0IxnmegewDcjWg4Z---lckoo04");
